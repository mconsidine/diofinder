...
flowchart TD
    ...
    SC --> C3["3 · POINTING BETWEEN SOLVES<br/>comms._imu_predict_smoothed<br/>RA/Dec = imu_calib_C applied to (imu_q vs imu_ref_q)<br/>α-β smoothed · α=0.25 β=0.05<br/>served on LX200 :GR / :GD @ 20 Hz<br/>NEEDS calibration"]
